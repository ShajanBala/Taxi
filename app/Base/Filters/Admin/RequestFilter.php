...
class RequestFilter implements FilterContract
{
    ...
    {
        return [
            'is_completed','is_cancelled','is_trip_start','is_paid','payment_opt','vehicle_type','is_assigned','is_later','out_station','on_trip'
        ];
    }
    ...
    */
    ...
    public function out_station($builder,$value=0){

        $builder->where('is_out_station', $value)->where('is_later', $value)->where('is_completed',false)->where('is_cancelled',false);
