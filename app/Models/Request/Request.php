...
class Request extends Model
{
    ...
    */
    public function getVehicleTypeNameAttribute()
    {
        ...
        if (!$this->zoneType->driverVehicleType->vehicleType()->exists()) {
            return null;
        }
        return $this->zoneType->driverVehicleType->vehicleType->name;
    }
     /**
    * Get vehicle type's name.
    *
    ...
    */
    public function getVehicleTypeImageAttribute()
    {
        ...
        return $this->zoneType->driverVehicleType->vehicleType->icon;
    }
    /**
    * Get vehicle type's name.
    *
    ...
    */
    public function getVehicleTypeIdAttribute()
    {
        ...
        return $this->zoneType->driverVehicleType->vehicleType->id;
    }
    /**
